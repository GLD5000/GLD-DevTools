...
#### This will be a [Next.js](https://nextjs.org/) project with [Stripe Payment GateWay](https://support.stripe.com/topics/getting-started) and:
...
> #### You can also use the template for this project: [GLD-StripeTemplate](https://github.com/GLD5000/GLD-StripeTemplate)
