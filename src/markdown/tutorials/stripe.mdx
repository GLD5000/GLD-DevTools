...
### This will be a [Next.js](https://nextjs.org/) project with [Stripe Payment GateWay](https://support.stripe.com/topics/getting-started):
...
### You can also find the template for this project [here](https://github.com/GLD5000/GLD-StripeTemplate)
