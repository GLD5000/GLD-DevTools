...
path: https://gld-dev-tools.vercel.app/parser/${parsingFunction}/`}</pre>
      <textarea
        className="text-white w-full bg-black max-w-[1000px] min-w-[280px] resize"
        name="input"
      ...
      <p className="w-full text-white bg-black max-w-[1000px] text-ellipsis line-clamp-3 overflow-hidden">
        {output}
      </p>
    </div>
  );
